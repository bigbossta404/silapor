...
{
    protected $_ci;
    // protected $email_pengirim = 'fakhrifadlan14@gmail.com'; // Isikan dengan email pengirim
    // protected $nama_pengirim = 'Kepolisian Pakualaman'; // Isikan dengan nama pengirim
    // protected $password = 'spongebob404'; // Isikan dengan password email pengirim
    ...
    public function send($data)
    {
        ...
        $mail->Password = $data['pass']; // Isikan dengan Password email pengirim
        $mail->Port = 465;
        $mail->SMTPAuth = true;
        $mail->SMTPSecure = 'ssl';
